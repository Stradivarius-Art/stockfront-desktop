...
namespace StockFront.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Optimistic-locking token: make MySQL bump RowVersion on every UPDATE, not just INSERT.
            // EF only emits the DEFAULT; the ON UPDATE clause is added explicitly so two concurrent
            // reservations of the last item cannot both succeed.
            migrationBuilder.Sql(
                "ALTER TABLE `StockItems` MODIFY `RowVersion` timestamp(6) NOT NULL " +
